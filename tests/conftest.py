...
def setup_gl_state():
    ...
    gl_instance.message.block_number = 100
    ...
    gl_instance.nondet.exec_prompt = lambda prompt, response_format=None: {
        ...
        "confidence": 95,
        "evidence_sources": ["Obituary site"],
        "red_flags": [],
        "reasoning": "Confirmed deceased from multiple online obituaries.",
        "estimated_death_date": "2026-06-01"
    }
    gl_instance.nondet.web.render = lambda url, mode=None: "Obituary page content"
...
@pytest.fixture
def contract():
    """Initializes and returns a fresh AfterLife contract instance."""
    from contracts.afterlife import AfterLife
    return AfterLife()
